...
class FCSfpView(unittest.TestCase):
    def test_fc_sfp_view(self):
        ...
        time.sleep(1)
        driver.find_element_by_xpath("//button[@title='View SFP Information']").click()
        time.sleep(2)
        if driver.find_element_by_xpath("//div[3]/div[2]/div/div/div/div[2]/div").text != "":
            tolog(driver.find_element_by_xpath("//div[3]/div[2]/div/div/div/div[2]/div").text)
