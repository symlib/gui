...
class ISCSIPortalAddPhysical(unittest.TestCase):
    def test_iscsi_portal_add_physical(self):
        ...
        time.sleep(2)
        if driver.find_element_by_xpath("//form/div[1]/div/label[1]/input").is_enabled():
            ...
            time.sleep(1)
            driver.find_element_by_xpath("//form/div[6]/div[1]/label/input").click()
            time.sleep(1)
